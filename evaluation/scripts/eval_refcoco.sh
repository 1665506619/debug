...
# DATASET_LIST=("refcoco_val" "refcoco_testA" "refcoco_testB" "refcoco+_val" "refcoco+_testA" "refcoco+_testB" "refcocog_val" "refcocog_test")
DATASET_LIST=("refcocog_val" "refcocog_test")
