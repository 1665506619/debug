...
def calculate_iou(pred_mask, gt_mask):
    ...
    gt_mask_sum = gt_mask.sum(dim=(1, 2))

    zero_idx = (gt_mask_sum == 0)
    nonzero_idx = (gt_mask_sum != 0)
    ...
    iou_zero = iou[zero_idx]
    iou_nonzero = iou[nonzero_idx]

    return iou_zero, iou_nonzero

def calculate_iou_flatten(pred_mask, gt_mask):
