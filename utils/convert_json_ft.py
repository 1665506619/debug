...
data_root = "/lustre/fs11/portfolios/llmservice/users/zhidingy/wsh-ws/playground/region/data/seg_train/seg-train"
new_data_root = "/lustre/fs11/portfolios/llmservice/users/zhidingy/wsh-ws/playground/region/data/seg_train/seg-train/new_ft"
cache_dir = "/lustre/fs11/portfolios/llmservice/users/zhidingy/wsh-ws/playground/region/data/seg_train/seg-train/cache_ft"

data_list = [
    "llava_v1_5_mix665k_wo_bbox.json",
    "reason_seg_cat.json",
...
def _rewrite_one_record(d: dict, ensure_ascii: bool = False) -> Optional[dict]:
    ...
    if (not annotation or len(annotation) == 0) and 'conversations' not in d:
        return None
    ...
    if annotation is not None:
        ...
        d["annotation"] = json.dumps(annotation, ensure_ascii=False)

    if "conversations" in d:
        d["conversations"] = json.dumps(d["conversations"], ensure_ascii=False)
    return d
