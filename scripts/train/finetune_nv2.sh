...
WORK_DIR=./work_dirs
RUN_NAME=0113_ft_v4_base_0109_pretrain_v8_half_lr_bs_64_lora
...
MODEL_ARGS=(
    --model_path /lustre/fs11/portfolios/llmservice/projects/llmservice_nlp_fm/users/zhidingy/wsh-ws/playground/region/code/seg-sam3/work_dirs/0109_pretrain_v8_lora_merge
...
DATA_ARGS=(
    --ann_path ./data/ft_v4.txt
    --data_root /lustre/fs11/portfolios/llmservice/users/zhidingy/wsh-ws/playground/region/data
    --data_path_root /lustre/fs11/portfolios/llmservice/users/zhidingy/wsh-ws/playground/region/data/seg_train/seg-train/new_ft
    --data_cache_dir /lustre/fs11/portfolios/llmservice/users/zhidingy/wsh-ws/playground/region/data/seg_train/seg-train/cache_ft
